...
public class HistoryDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable1 = "create table " + TABLE_NAME + " (uid text, solutionData text, solutionImg text )" ;
    ...
    public boolean addData(String uid, String solutionData, String solutionImg) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues contentValues = new ContentValues();
        contentValues.put(COL1, uid);
        contentValues.put(COL2, solutionData);
        contentValues.put(COL3, solutionImg);
